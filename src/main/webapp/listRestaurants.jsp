...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="listRestaurants">餐厅列表</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="addRestaurant.jsp">添加餐厅</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="updateRestaurant.jsp">更新餐厅</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="deleteRestaurant.jsp">删除餐厅</a>
            </li>
            <li class="nav-item">
...
<div class="container mt-5">
    ...
    <!-- 查询表单 -->
    <form action="listRestaurants" method="get" class="mb-3">
        <div class="form-row">
